...
export type GetTransactionQuery = { __typename?: 'query_root', transaction: Array<{ __typename?: 'transaction', amount: any, label: string, transaction_type: string, created_at: any, updated_at: any, id: any, user_id: any, company: { __typename?: 'company', id: any, label: string, logo?: string | null }, budget: { __typename?: 'budget', id: any, label: string } }> };
