...
export type GetLiteCompaniesQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;


export type GetLiteCompaniesQuery = { __typename?: 'query_root', company: Array<{ __typename?: 'company', id: any, label: string, logo?: string | null }> };
...
export type GetBudgetsQuery = { __typename?: 'query_root', budget: Array<{ __typename?: 'budget', id: any, label: string, icon: string }> };
